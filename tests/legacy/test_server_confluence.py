#!/usr/bin/env python3
"""
Test script for Confluence Server API connection.
This script tests the connection to Confluence Server using direct API calls.
"""
...
def main():
    """Test connection to Confluence Server API."""
    console.print("[bold]Testing Confluence Server API Connection[/bold]")
    
    # Get configuration from environment variables
    confluence_url = os.environ.get("CONFLUENCE_URL")
    api_token = os.environ.get("CONFLUENCE_API_TOKEN")  # For Server, this is the password
    email = os.environ.get("CONFLUENCE_EMAIL")  # For Server, this is the username
    ...
    console.print("\n[bold]Testing connection to Confluence Server...[/bold]")
    ...
    if not success:
        console.print(Panel(
            "Failed to connect to any Confluence Server API endpoint. "
        ...
        console.print("1. Verify that the Confluence URL is correct")
        console.print("2. Ensure your username and password are valid")
        console.print("3. Check if your account has API access permissions")
        console.print("4. Try accessing the Confluence web interface with the same credentials")
        console.print("5. Check if the Confluence server requires additional authentication methods")
