...
# Import Enhanced Agentic Assistant module
try:
    from agentic_assistant_enhanced import enhanced_agentic_assistant_mode, handle_enhanced_agentic_assistant_task
    ENHANCED_AGENTIC_ASSISTANT_AVAILABLE = True
except ImportError:
    ENHANCED_AGENTIC_ASSISTANT_AVAILABLE = False
...
def display_menu():
    ...
    if ENHANCED_AGENTIC_ASSISTANT_AVAILABLE:
        commands["assistant"] = lambda: asyncio.run(enhanced_agentic_assistant_mode())
    elif AGENTIC_ASSISTANT_AVAILABLE:
    ...
    # Add agentic assistant if available
    if ENHANCED_AGENTIC_ASSISTANT_AVAILABLE or AGENTIC_ASSISTANT_AVAILABLE:
        menu_items.append((str(menu_option_number), "assistant", "Enhanced Agentic Assistant"))
        menu_option_number += 1
