#!/usr/bin/env python3
"""
Filesystem MCP Server Installation Script

This script installs and configures the Python-based Filesystem MCP Server for Ollama Shell.
"""
...
REQUIREMENTS_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "requirements_mcp.txt")
...
def copy_server_file():
    ...
    server_source = os.path.join(os.path.dirname(os.path.abspath(__file__)), "filesystem_mcp_server.py")
